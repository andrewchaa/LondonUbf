...
namespace LondonUbf.Test.Integration
{
    ...
    public class MessageRepositoryTest
    {
        ...
        public void Should_List_Files_In_The_Message_Directory()
        {
            ...
            Assert.That(messages.First().FileName, Is.EqualTo("2012 Genesis 1 1.1-1.25 In The Beginning.js"));
        ...
        {
            var message = _repository.Find("2012 Genesis 1 1.1-1.25 In The Beginning.js");
