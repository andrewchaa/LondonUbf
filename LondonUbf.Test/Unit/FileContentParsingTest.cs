...
";
        ...
        [Test]
        public void Should_Get_LectureNo_At_The_End_Of_The_Line_Tab_Characters()
        {
            const string content = @"2011 Luke 20
...
";
        ...
        [Test]
        public void Should_Parse_Chapter_With_Empty_Tab_Characters()
        {
            const string content =
                @"
2011 Luke 12
...
Luke 8:1-21";
            ...
            Assert.That(message.Year, Is.EqualTo(2011));
            Assert.That(message.Book, Is.EqualTo("Luke"));
            Assert.That(message.LectureNo, Is.EqualTo(12));
            Assert.That(message.Title, Is.EqualTo("Hear The Word"));
            Assert.That(message.Chapter, Is.EqualTo("8:1-21"));
